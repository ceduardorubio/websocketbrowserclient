(() => {
  ...
  function compareSubstring(a2, b, aStart = 0, aEnd = a2.length, bStart = 0, bEnd = b.length) {
  ...
  function compareIgnoreCase(a2, b) {
    return compareSubstringIgnoreCase(a2, b, 0, a2.length, 0, b.length);
  }
  function compareSubstringIgnoreCase(a2, b, aStart = 0, aEnd = a2.length, bStart = 0, bEnd = b.length) {
    for (; aStart < aEnd && bStart < bEnd; aStart++, bStart++) {
      let codeA = a2.charCodeAt(aStart);
      let codeB = b.charCodeAt(bStart);
      if (codeA === codeB) {
      ...
      if (codeA >= 128 || codeB >= 128) {
        return compareSubstring(a2.toLowerCase(), b.toLowerCase(), aStart, aEnd, bStart, bEnd);
      }
  ...
  var ConfigKeysIterator = class {
    ...
    cmp(a2) {
      return this._caseSensitive ? compareSubstring(a2, this._value, 0, a2.length, this._from, this._to) : compareSubstringIgnoreCase(a2, this._value, 0, a2.length, this._from, this._to);
    }
    value() {
  ...
  var UriIterator = class {
    ...
    cmp(a2) {
      if (this._states[this._stateIdx] === 1) {
        return compareIgnoreCase(a2, this._value.scheme);
      } else if (this._states[this._stateIdx] === 2) {
        return compareIgnoreCase(a2, this._value.authority);
      } else if (this._states[this._stateIdx] === 3) {
        return this._pathIterator.cmp(a2);
      } else if (this._states[this._stateIdx] === 4) {
        return compare(a2, this._value.query);
      } else if (this._states[this._stateIdx] === 5) {
        return compare(a2, this._value.fragment);
      }
      throw new Error();
    }
    value() {
  ...
  var LanguageFeatureRegistry = class {
    ...
    static _compareByScoreAndTime(a2, b) {
      if (a2._score < b._score) {
        return 1;
      } else if (a2._score > b._score) {
        return -1;
      } else if (a2._time < b._time) {
        return 1;
      } else if (a2._time > b._time) {
        return -1;
      } else {
          ...
          case "uri-reference":
            {
              ...
              if (!node2.value) {
                ...
                var match2 = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/.exec(node2.value);
                if (!match2) {
                  errorMessage = localize2("uriMissing", "URI is expected.");
                } else if (!match2[2] && schema22.format === "uri") {
  ...
  var JSONSchemaService = function() {
    ...
    JSONSchemaService2.prototype.loadSchema = function(url) {
      ...
      return this.requestService(url).then(function(content) {
        ...
        var schemaContent = {};
        var jsonErrors = [];
        schemaContent = parse22(content, jsonErrors);
    ...
    JSONSchemaService2.prototype.getSchemaFromProperty = function(resource, document) {
      var _a4, _b2;
      if (((_a4 = document.root) === null || _a4 === void 0 ? void 0 : _a4.type) === "object") {
